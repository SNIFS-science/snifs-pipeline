...
class PreprocessExposureConfig(FlowConfig):
    ...
    bias_image_file: FileType.BIAS.OptionalPath = Field(default=None, validate_default=True)
    bias_model_file: FileType.BIAS_MODEL.OptionalPath = Field(default=None, validate_default=True)
    dark_image_file: FileType.DARK.OptionalPath = Field(default=None, validate_default=True)
    dark_model_file: FileType.DARK_MODEL.OptionalPath = Field(default=None, validate_default=True)
    flat_image_file: FileType.CONTINUUM.OptionalPath = Field(default=None, validate_default=True)
    ccd_on_time_file: FileType.CCD_ON_TIMES.OptionalPath = Field(default=None, validate_default=True)
    binary_offset_model_file: FileType.BINARY_OFFSET_MODEL.OptionalPath = Field(default=None, validate_default=True)
