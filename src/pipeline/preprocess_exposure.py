...
class PreprocessExposureConfig(FlowConfig):
    ...
    bias_image_file: FileType.BIAS.Path | None = Field(default=None, validate_default=True)
    bias_model_file: FileType.BIAS_MODEL.Path | None = Field(default=None, validate_default=True)
    dark_image_file: FileType.DARK.Path | None = Field(default=None, validate_default=True)
    dark_model_file: FileType.DARK_MODEL.Path | None = Field(default=None, validate_default=True)
    flat_image_file: FileType.CONTINUUM.OptionalPath | None = Field(default=None, validate_default=True)
    ccd_on_time_file: FileType.CCD_ON_TIMES.Path | None = Field(default=None, validate_default=True)
    binary_offset_model_file: FileType.BINARY_OFFSET_MODEL.Path | None = Field(default=None, validate_default=True)
