...
@file_match_registry.register(FileType.DARK_MODEL)
def find_dark_model_files(primary_file: FileStoreEntry | None, file_store: FileStoreDataFrame) -> list[FileStoreEntry]:
    """
    Find the arc file for a given science file.
    """
    assert primary_file is not None, "science_file must be provided. There is no global suitable dark model file."
